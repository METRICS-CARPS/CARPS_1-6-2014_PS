...
```{r}
# I need to get "condition" split into two columns, 0 (laptop) and 1 (longhand)?
# I just used group_by and it seems to have worked.
...
aovFactual <- aov(condition~objectiveZ, data=data)
summary(aovFactual)


# on partial eta squared: https://en.wikiversity.org/wiki/Eta-squared
# on mixed effect ANOVA in R: http://www.page-gould.com/r/anova/
# and another on mixed effect ANOVA in R: http://conjugateprior.org/2013/01/formulae-in-r-anova/
# on ANOVA as statistic: http://proquest.safaribooksonline.com/book/statistics/9781449361129/8dot-introduction-to-regression-and-anova/analysis_of_variance_open_parenthesis_an_html#X2ludGVybmFsX0h0bWxWaWV3P3htbGlkPTk3ODE0NDkzNjExMjklMkZmYWN0b3JpYWxfYW5vdmFfaHRtbCZxdWVyeT10JTIwdGVzdA==
```

```{r}
# Deal with only Conceptual-application questions (openZ)
